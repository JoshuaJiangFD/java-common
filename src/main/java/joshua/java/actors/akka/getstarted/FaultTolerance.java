...
import static joshua.java.actors.akka.getstarted.CounterApi.*;
import static joshua.java.actors.akka.getstarted.CounterServiceApi.*;
import static joshua.java.actors.akka.getstarted.StorageApi.*;
import static joshua.java.actors.akka.getstarted.WorkerApi.*;

import akka.actor.SupervisorStrategy.Directive;

/**
 * Example for Fault Tolerance in Akka.
 *
 ...
 */
class CounterService extends UntypedActor {
    ...
    private static SupervisorStrategy strategy = new OneForOneStrategy(3, Duration.create("5 seconds"),
            new akka.japi.Function<Throwable, Directive>() {
                @Override
 ...
 */
class Storage extends UntypedActor {
